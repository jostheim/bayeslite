...
from crosscat.MultithreadingEngine import MultithreadingEngine as CrossCatMultiThreadingEngine
...
bayesdb_builtin_metamodel(CrosscatMetamodel(CrossCatMultiThreadingEngine(seed=0, cpu_count=8)))
